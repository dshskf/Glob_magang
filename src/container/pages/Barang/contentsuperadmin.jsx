...
import { getDataCategoryAPI, getDataSellerAPI, getDataBarangSellerAPI, getDataBarangAPI, getDataDetailedBarangAPI, 
    getDataStatusMasterBarangAPI, getDataDetailedBarangSuperAdminOnConfirmAPI, getKursAPI, getKursAPIManual,
    updateBarangStatus, logoutUserAPI } from '../../../config/redux/action';
import { Modal, ModalHeader, ModalBody, ModalFooter, Button, ButtonDropdown, DropdownItem, 
    DropdownMenu, DropdownToggle, Input, Badge } from 'reactstrap'
