...
class ContentKurs extends Component {
    ...
    handleChangeTimeMulaiBerlakuSelected = async(e) => {
        await this.setState({dateMulaiBerlakuSelected: e._d, momentdateMulaiBerlakuSelected: e, 
    ...
    handleChangeTimeBerakhirSelected = async(e) => {
        await this.setState({dateBerakhirSelected: e._d, momentdateBerakhirSelected: e,
