...
import { getDataSalesAPI, getDataDetailedSalesAPI, getDataCheckedKodeSales, getDataCategoryAPI, getDataUsernameAPI, 
...
class ContentSales extends Component {
        ...
        if (e === '') {
            ...
            if (e.length < 8 && e.length > 0){
                ...
                if (check_username !== '' && check_username.length === 0){
                    this.setState({validation_username_sales_inserted: true, empty_username_sales_inserted: false, 
                        feedback_username_sales_inserted: ''})
                        // handle button
                    ...
                    this.setState({validation_username_sales_inserted: false, empty_username_sales_inserted: true,
    ...
    check_field_telepon_sales = (e) => {
        if (e === '') {
            this.setState({empty_no_hp_sales_inserted: true, feedback_no_hp_sales_inserted:'Kolom ini wajib diisi',
                isBtnInsert: true})
        } else {
            if (e.length > 15) {
                this.setState({
    ...
    handleModalConfirmInsert = async() => {
        ...
        if (check_username !== '' && check_username.length === 0){
            if (Number(this.state.allCheckedKodeSales) > 0) {
                ...
                this.setState({validation_kode_sales_inserted: false, empty_kode_sales_inserted: true,
                ...
                if (Number(this.state.check_nohp_insert) > 0) {
                    this.setState({validation_no_hp_sales_inserted: false, empty_no_hp_sales_inserted: true,
                        feedback_no_hp_sales_inserted: 'Nomor telepon telah digunakan', isBtnInsert: true})
                }
                if (Number(this.state.check_email_insert) > 0) {
                    this.setState({validation_email_sales_inserted: false, empty_email_sales_inserted: true,
                        feedback_email_sales_inserted: 'Email telah digunakan', isBtnInsert: true})
                }
                if (Number(this.state.check_nik_insert) > 0) {
                    this.setState({validation_no_nik_sales_inserted: false, empty_no_nik_sales_inserted: true,
    ...
    check_field_username_sales_edited = (e) => {
        if (e === '') {
            ...
            if (e.length < 8 && e.length > 0){
                ...
                let check_username = this.state.allUsername.filter(input_username => {return input_username.username === e });
                if (check_username !== '' && check_username.length === 0){
                    this.setState({validation_username_sales: true, empty_username_sales: false, 
                        feedback_username_sales: ''})
                        // handle button
                        // if (this.state.nama_sales !== '' && this.state.no_ktp_sales.length === 16 &&
                        if (this.state.nama_sales !== '' && this.state.no_nik_sales !== '' &&
                    ...
                    this.setState({validation_username_sales: false, empty_username_sales: true,
    ...
    check_field_telepon_sales_edited = (e) => {
        if (e === '') {
            this.setState({empty_no_hp_sales: true, feedback_no_hp_sales:'Kolom ini wajib diisi',
                isBtnUpdate: true})
        } else {
            if (e.length > 15) {
                this.setState({
    ...
    handleModalConfirm = async() => {
        ...
        if (check_username !== '' && check_username.length === 0){
            if (this.state.kode_sales === this.state.pembanding_kode_sales && Number(this.state.allCheckedKodeSales) === 1) {
                ...
                if (Number(this.state.allCheckedKodeSales) > 0) {
                    this.handleModalAttentionKodeSales()
                    this.setState({validation_kode_sales: false, empty_kode_sales: true,
