...
import { loginUserAPI, getKodeSalesLoginAPI, getPassword, sendOtp, getOtp, getDataCheckedNomorHp, updateUserStatus, loginSuperAdminAPI } from '../../../config/redux/action';
import { Input, Modal, ModalHeader, ModalBody, ModalFooter, ButtonDropdown, DropdownItem, 
    DropdownMenu, DropdownToggle, FormGroup } from 'reactstrap'
...
class Login extends Component {
                ...
                if (decrypt(res.status)==="success"){
                    ...
                    if (resnonactive) {
                        ...
                        if (decrypt(resnonactive.status)==="success") {
                            this.handleModalOtp()
                            this.setState({dataLogin: resnonactive, id_sales_registered: decrypt(resnonactive.id_sales_registered),
    ...
    handleCheckingKodeSales = () => {
        this.setState({isOpenModalKodeSales: !this.state.isOpenModalKodeSales,
            kode_sales:'',
            validation_kode_sales: false,
            empty_kode_sales: false
        })
