    ...
    return(
        <Col xs="12" sm="12" md="3" className="product-card">
            <Card style={{marginBottom:'10%'}}>
                ...
                {
                    (props.data.flagstatus !== 'C' && props.sa_role === 'admin') ?
                        <div style={{position: "absolute", bottom: "0", right: "0", marginBottom:"3%", marginRight:"3%"}}>
                                <button className="mb-2 mr-2 btn-transition btn btn-outline-primary" onClick={()=> props.detail(props.data.id)}>Edit</button>
                        </div>
                    :   
                    <div style={{position: "absolute", bottom: "0", right: "0", marginBottom:"3%", marginRight:"3%"}}>
